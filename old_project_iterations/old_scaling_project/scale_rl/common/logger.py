...
def get_run_info(args):
    ...
    elif args.agent.actor_sparsity != 0.0 or args.agent.critic_sparsity != 0.0 and args.saliency_based_pruning:
        group = f"Saliency_{args.agent.agent_type}_{args.env.env_name}_RR={args.updates_per_interaction_step}_arch={args.agent.critic_block_type[:3]}"
    else:
