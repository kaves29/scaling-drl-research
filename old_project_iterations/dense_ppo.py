...
all_test_envs = ["Reacher", "Hopper"]
for test_env_count in range(config["experiment"]["num_test_envs"]):
    test_env = all_test_envs[test_env_count]
    ...
    class Args:
        ...
        env_id: str = config["envs"][test_env]["env_id"]
        """the id of the environment"""
        total_timesteps: int = config["envs"][test_env]["total_timesteps"]
    ...
    if __name__ == "__main__":
        for env_seed in range(config["experiment"]["num_seeds"]):
            args = tyro.cli(Args)
            args.batch_size = int(args.num_envs * args.num_steps)
            args.minibatch_size = int(args.batch_size // args.num_minibatches)
            args.num_iterations = args.total_timesteps // args.batch_size
            run_name = f"{args.env_id}__{args.exp_name}__{env_seed}"
            if args.track:
                import wandb
            ...
            if args.save_model:
                model_path = f"models/{run_name}/{args.exp_name}.validation_model"
